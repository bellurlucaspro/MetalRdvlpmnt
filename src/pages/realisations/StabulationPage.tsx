...
export default function StabulationPage() {
  ...
  const challenges = [
    "Intégration d'un système de ventilation naturelle optimisé",
    "Résistance aux vents forts de la région normande",
    "Installation rapide pour minimiser l'impact sur l'exploitation",
    "Respect des normes bien-être animal",
  ];

  const solutions = [
    "Structure métallique galvanisée à chaud pour une durabilité maximale",
    "Bardage ventilé avec ouvertures réglables automatiques",
    "Fondations renforcées calculées selon Eurocode",
    "Pré-assemblage en atelier pour un montage en 3 semaines",
  ];
    ...
    <div className="pt-32 pb-20 bg-white">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { label: "Durée", value: projectDetails.duration },
            { label: "Budget", value: projectDetails.budget },
          ].map((item, index) => (
            <motion.div
              key={index}
            ...
            >
              ...
              <p className="text-[#000000] text-[28px] font-rajdhani font-bold">{item.value}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-[48px] text-[#000000] mb-8 font-rajdhani font-bold uppercase relative inline-block">
            Le projet
            <motion.div
          ...
          <p className="text-[#1B1B1B] text-[18px] leading-relaxed max-w-4xl">
            Ce projet de stabulation moderne pour 180 vaches laitières représente l'excellence de notre savoir-faire en structures agricoles. 
            Conçu pour optimiser le bien-être animal et la productivité de l'élevage, ce bâtiment intègre les dernières innovations en matière 
            de ventilation naturelle et de gestion des flux. La structure métallique galvanisée garantit une durabilité exceptionnelle face aux 
            conditions climatiques normandes, tout en offrant une flexibilité d'aménagement intérieur permettant d'adapter les espaces selon 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-[36px] text-[#000000] mb-8 font-rajdhani font-bold uppercase">
                Défis
              </h3>
              <div className="space-y-4">
                {challenges.map((challenge, index) => (
                  ...
                  >
                    <div className="w-8 h-8 bg-[#E40714]/10 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="space-y-4">
                {solutions.map((solution, index) => (
                  <motion.div
                    ...
                    className="flex items-start gap-4 bg-white rounded-xl p-4 border-2 border-[#C6C6C6]/20 hover:border-[#E40714]/50 transition-all duration-300"
                  >
                    <CheckCircle size={24} className="text-[#E40714] flex-shrink-0 mt-1" />
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20">
        <motion.h2
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="text-[48px] text-[#000000] mb-12 font-rajdhani font-bold uppercase text-center relative inline-block w-full"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {projectDetails.gallery.map((image, index) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-[#000000]/0 group-hover:bg-[#000000]/30 transition-all duration-300" />
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-[42px] mb-6 font-rajdhani font-bold uppercase">Un projet similaire ?</h3>
            <p className="text-[18px] mb-8 max-w-2xl mx-auto leading-relaxed">
              Notre expertise en bâtiments agricoles est à votre service. Contactez-nous pour discuter de votre projet.
            </p>
